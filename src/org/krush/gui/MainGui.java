...
public class MainGui extends javax.swing.JFrame implements IUpdaterListener {
	...
	public MainGui() {
		...
		jEditorPane1.setFont(new java.awt.Font("Courier New", 0, 11));
		jEditorPane1.setEditorKit(JEditorPane.createEditorKitForContentType("text/html"));

		final Font font = jEditorPane1.getFont();
		...
		final Color foregroundColor = jEditorPane1.getForeground();
		final Color backgroundColor = jEditorPane1.getBackground();
  ...
  private void initComponents() {
    ...
    jEditorPane1 = new org.krush.gui.JEditorPaneEx();
  ...
  private org.krush.gui.JEditorPaneEx jEditorPane1;
  ...
  // End of variables declaration//GEN-END:variables
	...
	public void log(String message) {
		...
		this.jEditorPane1.append(message);
		try {
			if (this.log != null) {
	...
	public void finished(boolean success) {
		if (success) {
			...
			log("Please restart the updater...");
		}
